...
public class AuthSender {
	public static void main(String[] args) throws Exception {
		...
		/** 输入用户名，即邮箱  */
		String username = encoder.encode("chuzm15@mails.tsinghua.edu.cn".getBytes())+"\r\n";
		System.out.print(username);
		os.write(username.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
		splits = response.split(" ");
		code = Integer.valueOf(splits[0]);	//把-1改为合适的代码
		...
		/** 输入密码  */
		String password = encoder.encode("xxxxxx".getBytes())+"\r\n"; //为了保护隐私，将密码打码
		System.out.print(password);
		os.write(password.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
		splits = response.split(" ");
		code = Integer.valueOf(splits[0]);	//把-1改为合适的代码
		...
		/** 发送 MAIL FROM 命令. */
		// TODO: 5.填入命令
		command = "MAIL FROM: <chuzm15@mails.tsinghua.edu.cn>\r\n";
		...
		/** 发送 RCPT TO 命令. */
		// TODO: 7.填入命令
		command = "RCPT TO: <chuzhumin98@126.com>\r\n";
		...
		str = "Hi TA\r\n  I am very glad to inform you that I successfully "
				+ "complete the Simple SMTP with authentication.\n"
				+ "I am Chu Zhimin. My studentID is 2015012177." + "\r\n";
		System.out.print(str);
		os.write(str.getBytes("US-ASCII"));
